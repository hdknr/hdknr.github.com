...
latex_documents = [
  ('index', 'accounts.tex', u'accounts Documentation',
   u'HDKNR.COM', 'manual'),
]
...
man_pages = [
    ('index', 'accounts', u'accounts Documentation',
     [u'HDKNR.COM'], 1)
]
...
epub_title = u'accounts'
epub_author = u'HDKNR.COM'
epub_publisher = u'HDKNR.COM'
epub_copyright = u'2011, HDKNR.COM'

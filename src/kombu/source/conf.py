# -*- coding: utf-8 -*-
#
# Kombu Docs documentation build configuration file, created by
# sphinx-quickstart on Fri Aug 17 08:57:32 2012.
#
...
project = u'Kombu Docs'
copyright = u'2012, HDKNR.COM'
...
htmlhelp_basename = 'KombuDocsdoc'
...
latex_documents = [
  ('index', 'KombuDocs.tex', u'Kombu Docs Documentation',
   u'HDKNR.COM', 'manual'),
]
...
man_pages = [
    ('index', 'kombudocs', u'Kombu Docs Documentation',
     [u'HDKNR.COM'], 1)
]
...
texinfo_documents = [
  ('index', 'KombuDocs', u'Kombu Docs Documentation',
   u'HDKNR.COM', 'KombuDocs', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'Kombu Docs'
epub_author = u'HDKNR.COM'
epub_publisher = u'HDKNR.COM'
epub_copyright = u'2012, HDKNR.COM'
...
# Kombu
import kombu
KOMBU_DIR=os.path.dirname(kombu.__file__)
sys.path.append(os.path.join(KOMBU_DIR, "tests"))

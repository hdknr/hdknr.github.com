# -*- coding: utf-8 -*-
#
# Django Cheat documentation build configuration file, created by
...
htmlhelp_basename = 'DjangoCheatdoc'
...
latex_documents = [
  ('index', 'DjangoCheat.tex', u'Django Cheat Documentation',
   u'HDKNR.COM', 'manual'),
]
...
man_pages = [
    ('index', 'djangocheat', u'Django Cheat Documentation',
     [u'HDKNR.COM'], 1)
]
...
texinfo_documents = [
  ('index', 'DjangoCheat', u'Django Cheat Documentation',
   u'HDKNR.COM', 'DjangoCheat', 'One line description of project.',
   'Miscellaneous'),
]
